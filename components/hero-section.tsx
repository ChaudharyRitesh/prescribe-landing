        ...
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-[1.05fr_1fr] lg:gap-12">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -left-4 top-10 hidden rounded-xl border border-white/10 bg-slate-900/90 p-3.5 shadow-xl backdrop-blur md:block lg:-left-10"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 right-2 hidden rounded-xl border border-white/10 bg-slate-900/90 p-3.5 shadow-xl backdrop-blur md:block lg:-right-6"
            >
              <div className="flex items-center gap-3">
