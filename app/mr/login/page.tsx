    ...
    <div className="min-h-screen bg-neutral-50 flex flex-col md:flex-row">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6 max-w-lg">
            <h1 className="text-4xl lg:text-5xl font-bold tracking-tight leading-tight">
              Welcome Back to the <br /> <span className="text-[#00DACC]">MR Portal</span>
            </h1>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-24 relative bg-white">
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-neutral-900 mb-2">MR Login</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end">
              <Link href="/mr/forgot-password" className="text-sm text-neutral-500 hover:text-[#00DACC]">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-neutral-600">
                ...
                <Link href="/mr/register" className="text-[#00DACC] font-semibold hover:underline">
