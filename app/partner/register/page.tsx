    ...
    <div className="min-h-screen bg-neutral-50 flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-col justify-between md:w-[42%] bg-[#051114] text-white p-12 lg:p-20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-sm text-neutral-500">
            © {new Date().getFullYear()} Kaero Group. Join the healthcare revolution.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 lg:p-24 relative bg-white">
        ...
        <div className="w-full max-w-md mt-16 md:mt-0">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-neutral-900 mb-2">Apply as Partner</h2>
            <p className="text-neutral-500">Enter your details to register and access the Partner dashboard.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="relative phone-input-container">
                  <PhoneInput
                    ...
                    className="flex w-full py-2 border border-neutral-200 rounded-xl focus-within:ring-2 focus-within:ring-[#00DACC]/50 focus-within:border-[#00DACC] transition-shadow outline-none"
            ...
            <div className="text-center mt-4">
              <p className="text-sm text-neutral-600">
                ...
                <Link href="/partner/login" className="text-[#00DACC] font-semibold hover:underline">
                  Login here
                </Link>
              </p>
            </div>
