...
import WithdrawalModal from "@/components/partner/dashboard/WithdrawalModal";
import { format } from "date-fns";
import { useState } from "react";

export default function EarningsPage() {
  const { userData, withdrawals, withdrawalsPagination, refreshWithdrawals, loading } = useDashboard();
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Card>
        ...
        {withdrawalsPagination && withdrawalsPagination.pages > 1 && (
          <Box sx={{ 
            p: 2, 
            display: "flex", 
            alignItems: "center", 
            ...
            <Box sx={{ display: "flex", gap: 1 }}>
              <Button
                ...
                onClick={() => refreshWithdrawals(withdrawalsPagination.page - 1)}
              >
                Previous
              </Button>
              <Button
