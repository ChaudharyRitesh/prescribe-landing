...
export default function HospitalsPage() {
  const { pitches, pitchesPagination, loading, openNewPitchModal, refreshPitches } = useDashboard();
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Card sx={{ mb: 4 }}>
        ...
        {pitchesPagination && pitchesPagination.pages > 1 && (
          <Box sx={{ 
            p: 2, 
            display: "flex", 
            alignItems: "center", 
            ...
            <Typography variant="caption" sx={{ color: "text.secondary", fontWeight: 600 }}>
              Page {pitchesPagination.page} of {pitchesPagination.pages}
            </Typography>
            <Box sx={{ display: "flex", gap: 1 }}>
              <Button
                size="small"
                variant="text"
                disabled={pitchesPagination.page === 1}
                onClick={() => refreshPitches(pitchesPagination.page - 1)}
              >
                Previous
              </Button>
              <Button
                size="small"
                variant="text"
                disabled={pitchesPagination.page === pitchesPagination.pages}
                onClick={() => refreshPitches(pitchesPagination.page + 1)}
              >
                Next
              </Button>
