...
import ScheduleVisitModal from "@/components/partner/dashboard/ScheduleVisitModal";
import {
  format,
  addMonths,
  subMonths,
...
export default function CalendarPage() {
  const { scheduleEvents, schedulePagination, pitches, refreshSchedule } = useDashboard();

  React.useEffect(() => {
    // Fetch a large enough limit for the calendar view to ensure all month events are visible
    refreshSchedule(undefined, undefined, 1, 100);
  }, []);
